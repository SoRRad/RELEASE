// turbulent-flow.jsx
// Three.js + GSAP organic gradient background with turbulent shader.
// Adapted for scrollable page layouts — uses position:fixed for the canvas
// so content can scroll freely over the animated background.
...
export const Component = ({ children }) => {
  ...
  return (
    // Fixed canvas sits behind everything; content scrolls over it.
    <div style={{ position: 'relative', width: '100%', minHeight: '100vh' }}>
      {/* WebGL canvas — fixed so it stays in view while content scrolls */}
      <div
        ref={mountRef}
        style={{
          position: 'fixed',
